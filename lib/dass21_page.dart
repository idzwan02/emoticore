...
class _Dass21PageState extends State<Dass21Page> {
  ...
  static const Color instructionTextColor = Color(0xFF555555);
  static const Color questionTextColor = Color(0xFF222222);
  ...
  // --- ADDED: No _isLoading state needed if we build the PageView immediately ---
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(
                    isLastPage ? 'Finish Assessment' : 'Next Page',
  ...
  // (Keep _buildQuestionPage and _buildSingleQuestionUI as they were)
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              if (pageIndex == 0) ...[
                const Text(
                  "Please read each statement and select the option (0, 1, 2, or 3) which indicates how much the statement applied to you over the past week.",
                  style: TextStyle(
                    fontSize: 14.0,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          if (questionIndex < (startIndex + questionsPerPage - 1) &&
  ...
  // (Keep _goToNextPage, _goToPreviousPage, _checkIfCurrentPageAnswered as they were)
  void _goToNextPage() {
    if (_currentPage < 2) {
  ...
  // --- UPDATED _submitResults with Lottie ---
    ...
    if (currentUser != null) {
      ...
      try {
        ...
        if (Navigator.canPop(context))
          Navigator.pop(context); // Pop DASS screen
      } catch (e) {
        if (Navigator.canPop(context)) Navigator.pop(context); // Pop loading
